...
$sql = "INSERT INTO alertas (Descripcion, Foto_de_rotura) VALUES (?, ?)";
$stmt = $conn->prepare($sql);
$stmt->bind_param("ss", $_POST['Descripcion'], $rutaImagen);
$stmt->execute();
    ...
    if ($stmt->execute()) {
        echo "<div style='text-align:center; padding:20px; background:#d4edda; border:1px solid #28a745; color:#155724;'>
                <h3>✅ Alerta registrada correctamente</h3>
...
<!-- USAR GPS -->
<button type="button" onclick="compartirUbicacion()" >Usar mi ubicación</button>
